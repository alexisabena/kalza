  ...
  return (
    <article ref={ref} className="relative mb-2 break-inside-avoid overflow-hidden rounded-lg tablet-p:mb-4 tablet-l:mb-3">
      <Link to={`/producto/${product.id}`} className="block">
        ...
        <div
          className={cn(
            'pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-foreground/70 via-foreground/35 to-transparent p-3 pt-10',
        ...
        >
          <p className="truncate text-sm text-primary-foreground/90">{product.name}</p>

...
export function BottomNav() {
  ...
  const hidden = useScrollAware({ hideOn: 'down' })
  const t = useT()
  ...
  return (
    <nav
      className={cn(
        ...
        // tablet-p spans the full tablet width; tablet-l replaces this bar with
        // the floating nav (FloatingNav), so hide it there.
        'tablet-p:max-w-none tablet-l:hidden',
